...
const NAMES: Record<TrainingType,string> = {locate:'音名定位',identify:'反向识别',stringLocate:'指定弦定位',positionAssessment:'把位覆盖',allNotes:'同名音全搜',octave:'八度形状',interval:'音程定位',intervalShape:'音程形状',earLocate:'听音找指板',adaptive:'自适应复习',scaleDegree:'音阶音级',chordTone:'和弦内音',arpeggio:'琶音路径'}
